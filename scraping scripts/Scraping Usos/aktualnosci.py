...
def create_structured_json(announcements: list, source_url: str) -> dict:
    ...
    # Standardowe parsowanie dla strony main
...
async def main():
    url = "https://usosweb.pbs.edu.pl/kontroler.php?_action=news/default&panel=DOMYSLNY&file=main.html"
    print(f"Scrapowanie strony main: {url}")
    ...
    async with AsyncWebCrawler() as crawler:
        try:
            ...
            output_file = "structured_announcements_main.json"
            ...
            print(f"Błąd przy scrapowaniu main: {e}")
