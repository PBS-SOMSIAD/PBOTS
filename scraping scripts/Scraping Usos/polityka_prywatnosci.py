...
def create_structured_json(announcements: list, source_url: str) -> dict:
    ...
    # Standardowe parsowanie dla strony policy_privacy
...
async def main():
    url = "https://usosweb.pbs.edu.pl/kontroler.php?_action=news/default&panel=DOMYSLNY&file=policy_privacy.html"
    print(f"Scrapowanie strony policy_privacy: {url}")
    ...
    async with AsyncWebCrawler() as crawler:
        try:
            ...
            output_file = "structured_announcements_policy_privacy.json"
            with open(output_file, "w", encoding="utf-8") as f:
                json.dump(structured_data, f, ensure_ascii=False, indent=2)

            print(f"\nWyniki dla policy_privacy:")
            ...
            print(f"Błąd przy scrapowaniu policy_privacy: {e}")
